...
#define COL_RED 0x016F8669
#define COL_MOD 0x010C4383 // Modifiers
#define COL_NUM 0x010C4383 // Number keys
#define COL_ALT 0x01EEAE44 // Alternate alpanumerice
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        MO(3),          KC_1,         KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,        KC_EQL,  KC_BSPC, KC_DEL,  \
